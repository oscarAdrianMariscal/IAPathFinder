...
public class Terreno {
    ...
    public void crearColorRgb() {
        
        int i = 0;
        for (String nombre : nombres) {
        	if (nombre.toUpperCase().equals(color.toUpperCase()) ) {
        		colorRGB = hex2Rgb(hex[i]);
        		break;
        	}
        	i++;
        }
